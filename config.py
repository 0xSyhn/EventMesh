...
secret_env_path = "/secrets/app-env-vars.json/app-env-vars.json"
...
firebase_creds_path = settings.FIREBASE_CREDENTIALS or "/secrets/firebase-adminsdk.json/firebase-adminsdk.json"
